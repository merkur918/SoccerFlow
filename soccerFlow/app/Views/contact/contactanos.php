                ...
                <div class="contacto__form">
                    ...
                    <form id="formContacto" method="post">
                        <div class="contacto__form-group">
                            <label for="nombre" class="contacto__form-label">Nombre <span class="contacto__form-required">*</span></label>
                            <input type="text" id="nombre" name="nombre" class="contacto__form-input" placeholder="Tu nombre completo" required>
                        </div>
                        
                        <div class="contacto__form-group">
                            <label for="email" class="contacto__form-label">Email <span class="contacto__form-required">*</span></label>
                            <input type="email" id="email" name="email" class="contacto__form-input" placeholder="tu@email.com" required>
                        </div>
                        ...
                        <div class="contacto__form-group">
                            <label for="mensaje" class="contacto__form-label">Mensaje <span class="contacto__form-required">*</span></label>
                            <textarea id="mensaje" name="mensaje" class="contacto__form-textarea" placeholder="Escribe tu mensaje aquí..." required></textarea>
                        </div>
